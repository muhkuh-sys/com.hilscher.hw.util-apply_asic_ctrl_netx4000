...
proc validate {} {
  ...
  set RESULT 0
	  ...
	  if {$Val_asic_ctrl_io_config2 != $rd_value_asic_ctrl_io_config2} then {
		...
		set expected [ format "0x%08x" [expr $rd_value_asic_ctrl_clock_enable | $Val_asic_ctrl_clock_enable]]
  ...
  if {[ catch {jtag init} ]==0 } {
    ...
    # Download the snippet.
      ...
      global Val_asic_ctrl_clock_enable
	    ...
	    set Val_asic_ctrl_io_config       0x00000010
	    set Val_asic_ctrl_io_config2      0x00000070
	    set Val_asic_ctrl_clock_enable    0x00F00000
